...
user_interface = ('1 - сортировка по убыванию зарплат\n'
                  ...
                  '9 - вывести вакансии с зарплатой выше средней (по избранным работодателям)\n'
                  '10 - поиск вакансий по ключевому слову (по избранным работодателям)\n'
                  '0 - завершить работу\n'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # 9 - получить среднюю зарплату по вакансиям избранных работодателей и вывести вакансии с зп выще средней
        elif user_input == 9:
            ...
            print('Вакансии с зарпатой выше средней (выводятся где верхняя вилка либо выше средней, либо не указана):\n')
            db_manager.get_overprice_vacancies(average_salary, user_currency)

        # 10 - получить вакансии от избранных работодателей по ключевому слову
        elif user_input == 10:
            print('Поиск проводится по названию, требованиям и обязанностям')
            # получаем ключевое слово и преобразуем его для SQl запроса
            user_keyword = input('Введите ключевое слово для поиска вакансий от избранных работодателей: ')
            user_keyword = '%' + user_keyword + '%'
            db_manager.get_vacancies_by_keyword(user_keyword)
